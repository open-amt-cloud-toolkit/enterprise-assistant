...
namespace OpenAMTEnterpriseAssistant
{
    public static class Settings
    {
        ...
        {
            try { Registry.SetValue(@"HKEY_CURRENT_USER\SOFTWARE\Open Source\MeshCentral Satellite", name, value); } catch (Exception) { }
        }
        public static void SetRegValue(string name, bool value)
        {
            try { Registry.SetValue(@"HKEY_CURRENT_USER\SOFTWARE\Open Source\MeshCentral Satellite", name, value.ToString()); } catch (Exception) { }
        }
        /// <summary>
        ...
        {
            try {
                String v = (String)Registry.GetValue(@"HKEY_CURRENT_USER\SOFTWARE\Open Source\MeshCentral Satellite", name, value);
